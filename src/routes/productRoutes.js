...
const validationsEditProduct = [
    ...
    .isInt({ min:0, max: 95}).withMessage('El descuento debe ser un número entre 0 y 95'),
    body('category').isIn(['phones', 'tablets', 'laptops', 'ropa', 'detergentes', 'pisos', 'cosmetica', 'autos']).withMessage('Por favor, seleccionar una de las opciones'),
    body('brand').isIn(["Iphone","Apple","Samsung", "Motorola", "Huawei", "OnePlus", "Xiaomi","Jabón Económico", "Jabón con Oxi", "Jabón Lavandería", "Suavizante", "Perfumina", "Detergente 30%", "Detergente 70%", "Detergente Lavavajillas", "Desinfectante", "Desengrasante", "Desengrasante Industrial", "Desodorante", "Atrapapolvo", "Jabon de manos", "Shampoo", "Acondicionador", "Perfumes", "Alohol neutro", "Crema", "Shampoo Auto", "Brillagoma", "Silicona", "Perfume Auto", "Agua Destilada"]).withMessage('Por favor, seleccionar una de las opciones'),
    body('section').isIn(["lo mas buscado", "celulares", "laptops", "tablets", 'x1000L', 'x200L', 'x50L', 'x1L']).withMessage('Por favor, seleccionar una de las opciones'),
    body('images').custom((value, {req})=>{
        let file = req.file
        let acceptedExtensions = ['.jpg','.jpeg', '.png', '.gif']
